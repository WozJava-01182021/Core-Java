 ...
 * 
 * Primitives hold an actual value, reference variables hold an address to an object of a heap (p 54)
 */
package robertd.core_java.lesson01;

import robertd.core_java.lesson01.exercises.Car;
import robertd.core_java.lesson01.exercises.Dog;

class Book {}

public class References {
    public static void inClassWork() {    	
